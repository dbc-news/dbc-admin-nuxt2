<template>
  <aside class="px-1 mt-3 sm:mt-0">
    ...
    >
      <div class="p-2 pb-16 space-y-6 sm:p-3" v-if="image">
      ...
      <div class="fixed inset-y-0 w-full" v-else>
        <div class="relative flex flex-col flex-grow h-full bg-white">
          <div
            class="absolute mb-4 border-2 border-gray-200 border-dashed top-16"
          >
            <div
              class="flex items-center px-4 m-auto text-sm font-semibold text-green-500  h-96"
            >
              <div>Select an image to view and edit</div>
            </div>
          </div>
        </div>
      </div>
